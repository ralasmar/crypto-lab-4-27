...
const db = {
  ...
  testhashed: {
    username: "testhashed",
    password: "$2y$10$vYuwt7uLvz1Roc2zqBGqc.RhcAV3vallHeutYBGXeYy7HbmrVxIrG",
  },
};
...
app.post("/register", (req, res) => {
  ...
  // TODO: Display a success message to the user
    req.session.success = "Successfully joined!"
  }
  // TODO: If the user already exists, display an error message 
  else {
    req.session.error = "Username already taken, try again!"
  }
